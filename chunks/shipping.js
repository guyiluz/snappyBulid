...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Shipping__ = __webpack_require__(87);
/**
...
function action() {
  return {
    chunks: ['Shipping'],
    component: __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__components_Layout__["a" /* default */], null, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__Shipping__["a" /* default */], null))
  };
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Feedback__ = __webpack_require__(75);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__Footer__ = __webpack_require__(78);
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
// module
exports.push([module.i, "._1vSE5{background:#fff;color:#605e5e}._1EKFE{margin:0 auto;padding:20px 0;max-width:1000px;height:30px}._2ZSht{color:#92e5fc;text-decoration:none;font-size:1.75em}.dkY7q{margin-left:10px}._1vQSj{text-align:center}.J73k2{margin:0;padding:10px;font-weight:400;font-size:4em;line-height:1em}._1QHrc{padding:0;color:hsla(0,0%,100%,.5);font-size:1.25em;margin:0}", ""]);
  ...
  _createClass(Navigation, [{
    ...
    value: function render() {
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
        ...
        className: __WEBPACK_IMPORTED_MODULE_3__Navigation_css___default.a.link,
        to: "/shipping"
      }, "Shipping information"), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("span", {
...
// module
exports.push([module.i, ".d0C7s{float:right;margin:6px 0 0}._3unRI{display:inline-block;padding:3px 8px;text-decoration:none;font-size:1.125em}._3unRI,._3unRI:active,._3unRI:visited{color:#605e5e}._3unRI:hover{color:#0832ee}.PPdJ5{margin-right:8px;margin-left:8px;border-radius:3px;background:rgba(0,0,0,.15);color:#fff}.PPdJ5:hover{background:rgba(0,0,0,.3)}.cX3Pd{color:hsla(0,0%,100%,.3)}", ""]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_isomorphic_style_loader_lib_withStyles__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_isomorphic_style_loader_lib_withStyles___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_isomorphic_style_loader_lib_withStyles__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Footer_css__ = __webpack_require__(79);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_isomorphic_style_loader_lib_withStyles__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_isomorphic_style_loader_lib_withStyles___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_isomorphic_style_loader_lib_withStyles__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Shipping_css__ = __webpack_require__(88);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Shipping_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__Shipping_css__);
...
function (_React$Component) {
  ...
  function Shipping(props) {
    ...
    _this = _possibleConstructorReturn(this, (Shipping.__proto__ || Object.getPrototypeOf(Shipping)).call(this, props));
    Object.defineProperty(_this, "handleSubmit", {
      ...
      value: function value(event) {
        ...
        var _this$state$shipping = _this.state.shipping,
            firstName = _this$state$shipping.firstName,
            lastName = _this$state$shipping.lastName,
            email = _this$state$shipping.email,
            phoneNumber = _this$state$shipping.phoneNumber,
            conutry = _this$state$shipping.conutry,
            state = _this$state$shipping.state,
            city = _this$state$shipping.city,
            address1 = _this$state$shipping.address1,
            address2 = _this$state$shipping.address2,
            floor = _this$state$shipping.floor,
            zipCode = _this$state$shipping.zipCode,
            apartment = _this$state$shipping.apartment,
            specialNotes = _this$state$shipping.specialNotes; // Using Yaddress 
        ...
        line2[2] = shipping.zipCode; //added  proxyUrl for cross-origin requests

        var proxyUrl = 'https://guyi-coreapi.herokuapp.com/';
        var url = "https://www.yaddress.net/api/Address?AddressLine1=".concat(line1, "&AddressLine2=").concat(line2);
        fetch(proxyUrl + url).then(function (resp) {
          return resp.json();
        }).then(function (data) {
          if (!data.ErrorCode == 0) {
            _this.setState({
              valid: _extends({}, _this.state.valid, {
                error: true,
            ...
            console.log(shipping); // making the shipping data obj and sending it to the server
    ...
    Object.defineProperty(_this, "change", {
      ...
      value: function value(e) {
        _this.setState({
          shipping: _extends({}, _this.state.shipping, _defineProperty({}, e.target.name, e.target.value))
        });
      }
    });
    _this.state = {
  ...
  _createClass(Shipping, [{
    ...
    value: function render() {
      ...
      var _state = this.state,
          ...
          specialNotes = _state.specialNotes; // redring a msg if address is not valid

      var errMsg = "";

      if (this.state.valid.error) {
        errMsg = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4_semantic_ui_react__["Message"], {
      ...
      if (this.state.valid.success) {
        secMsg = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4_semantic_ui_react__["Message"], {
          positive: true
        }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4_semantic_ui_react__["Message"].Header, null, "thank you for using Snappy"), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p", null, " Your gift is on its way:)"));
      }

      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
        className: __WEBPACK_IMPORTED_MODULE_3__Shipping_css___default.a.root
      }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
        className: __WEBPACK_IMPORTED_MODULE_3__Shipping_css___default.a.container
      }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
        className: __WEBPACK_IMPORTED_MODULE_3__Shipping_css___default.a.form
      }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4_semantic_ui_react__["Form"], {
        onSubmit: this.handleSubmit,
        className: __WEBPACK_IMPORTED_MODULE_3__Shipping_css___default.a.flexForm
      ...
      })), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("h4", null, "Address"), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4_semantic_ui_react__["Form"].Group, {
        widths: "equal"
      }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4_semantic_ui_react__["Form"].Input, {
        value: state,
        label: "State",
      ...
      })), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4_semantic_ui_react__["Form"].Group, null, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4_semantic_ui_react__["Form"].Input, {
        value: floor,
        label: "Floor",
        type: "number",
        placeholder: "floor",
...
/* harmony default export */ __webpack_exports__["a"] = (__WEBPACK_IMPORTED_MODULE_2_isomorphic_style_loader_lib_withStyles___default()(__WEBPACK_IMPORTED_MODULE_3__Shipping_css___default.a)(Shipping));
...
/***/ (function(module, exports, __webpack_require__) {
    ...
    if (false) {
      var removeCss = function() {};
      module.hot.accept("!!../../../node_modules/css-loader/index.js??ref--1-rules-2!../../../node_modules/postcss-loader/lib/index.js??ref--1-rules-3!./Shipping.css", function() {
        content = require("!!../../../node_modules/css-loader/index.js??ref--1-rules-2!../../../node_modules/postcss-loader/lib/index.js??ref--1-rules-3!./Shipping.css");
...
// module
exports.push([module.i, ".SPWwe{padding-left:20px;padding-right:20px}._2BGRI{margin:0 auto;padding:0 0 40px}._16suz{display:-ms-flexbox;display:flex;-ms-flex-pack:center;justify-content:center;margin-top:20px}", ""]);
