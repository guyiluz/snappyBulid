...
function (_React$Component) {
  ...
  _createClass(NotFound, [{
    ...
    value: function render() {
      ...
      }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("h1", null, this.props.title), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p", null, "Sorry, the page you were trying to view does not exist.")));
    }
  }]);
...
function action() {
  return {
    chunks: ['not-found'],
    title: title,
    component: __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__components_Layout__["a" /* default */], null, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__NotFound__["a" /* default */], {
      title: title
    })),
    status: 404
  };
